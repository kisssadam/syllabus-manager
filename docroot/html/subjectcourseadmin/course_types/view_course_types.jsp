...
<aui:form method="post" name="fmCourseType">
	<liferay-ui:search-container delta="<%=delta%>" emptyResultsMessage="course-types-not-found" iteratorURL="<%=iteratorURL%>" rowChecker="<%= new RowChecker(renderResponse) %>">
...
<c:if test='<%=ModelPermission.contains(permissionChecker, scopeGroupId, ActionKeys.DELETE_COURSE_TYPES)%>'>
