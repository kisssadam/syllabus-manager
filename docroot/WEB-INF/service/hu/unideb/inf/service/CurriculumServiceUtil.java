...
public class CurriculumServiceUtil {
	...
	*/
	...
	public static CurriculumService getService() {
		if (_service == null) {
			InvokableService invokableService = (InvokableService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CurriculumService.class.getName());

			if (invokableService instanceof CurriculumService) {
				_service = (CurriculumService)invokableService;
			}
			else {
				_service = new CurriculumServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(CurriculumServiceUtil.class,
				"_service");
		}
	...
	private static CurriculumService _service;
}