	...
	*/
	...
	public static SemesterService getService() {
		if (_service == null) {
			...
			if (invokableService instanceof SemesterService) {
				_service = (SemesterService)invokableService;
			}
			else {
				_service = new SemesterServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(SemesterServiceUtil.class,
				"_service");
		}
