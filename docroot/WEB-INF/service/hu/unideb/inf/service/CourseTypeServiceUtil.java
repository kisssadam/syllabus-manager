...
public class CourseTypeServiceUtil {
	...
	*/
	...
	public static CourseTypeService getService() {
		if (_service == null) {
			InvokableService invokableService = (InvokableService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CourseTypeService.class.getName());

			if (invokableService instanceof CourseTypeService) {
				_service = (CourseTypeService)invokableService;
			}
			else {
				_service = new CourseTypeServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(CourseTypeServiceUtil.class,
				"_service");
		}
	...
	private static CourseTypeService _service;
}