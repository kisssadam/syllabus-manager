...
public class LecturerServiceUtil {
	...
	*/
	...
	public static LecturerService getService() {
		if (_service == null) {
			InvokableService invokableService = (InvokableService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					LecturerService.class.getName());

			if (invokableService instanceof LecturerService) {
				_service = (LecturerService)invokableService;
			}
			else {
				_service = new LecturerServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(LecturerServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(LecturerService service) {
	}

	private static LecturerService _service;
}