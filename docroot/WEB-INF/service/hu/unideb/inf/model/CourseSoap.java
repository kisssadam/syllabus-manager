...
/**
 * This class is used by SOAP remote services, specifically {@link hu.unideb.inf.service.http.CourseServiceSoap}.
 *
 * @author Adam Kiss
 * @see hu.unideb.inf.service.http.CourseServiceSoap
 * @generated
 */
public class CourseSoap implements Serializable {
	public static CourseSoap toSoapModel(Course model) {
		...
		soapModel.setHoursPerSemester(model.getHoursPerSemester());
		soapModel.setHoursPerWeek(model.getHoursPerWeek());
