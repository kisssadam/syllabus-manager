...
/**
 * The base model interface for the CourseType service. Represents a row in the &quot;unideb_syllabus_manager_CourseType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link hu.unideb.inf.model.impl.CourseTypeModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link hu.unideb.inf.model.impl.CourseTypeImpl}.
 * </p>
 *
 * @author Adam Kiss
 * @see CourseType
 ...
 * @generated
 */
public interface CourseTypeModel extends BaseModel<CourseType>, GroupedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a course type model instance should use the {@link CourseType} interface instead.
	 */
	...
	@Override
	public CacheModel<hu.unideb.inf.model.CourseType> toCacheModel();
