...
public class SyllabusUtil {
	...
	*/
	public static Syllabus findByT_S(long timetableCourseId, long semesterId)
		throws hu.unideb.inf.exception.NoSuchSyllabusException {
		return getPersistence().findByT_S(timetableCourseId, semesterId);
	}
	...
	*/
	public static Syllabus fetchByT_S(long timetableCourseId, long semesterId) {
		return getPersistence().fetchByT_S(timetableCourseId, semesterId);
	}
	...
	*/
	public static Syllabus fetchByT_S(long timetableCourseId, long semesterId,
		...
		return getPersistence()
				   .fetchByT_S(timetableCourseId, semesterId, retrieveFromCache);
	}
	...
	*/
	public static Syllabus removeByT_S(long timetableCourseId, long semesterId)
		throws hu.unideb.inf.exception.NoSuchSyllabusException {
		return getPersistence().removeByT_S(timetableCourseId, semesterId);
	}
	...
	*/
	public static int countByT_S(long timetableCourseId, long semesterId) {
		return getPersistence().countByT_S(timetableCourseId, semesterId);
	}
	...
	* @return the matching syllabuses
	*/
	public static List<Syllabus> findBySemesterId(long semesterId) {
	...
	* @return the range of matching syllabuses
	*/
	public static List<Syllabus> findBySemesterId(long semesterId, int start,
		int end) {
	...
	* @throws NoSuchSyllabusException if a matching syllabus could not be found
	*/
	public static Syllabus findBySemesterId_First(long semesterId,
		OrderByComparator<Syllabus> orderByComparator)
		throws hu.unideb.inf.exception.NoSuchSyllabusException {
		return getPersistence()
	...
	* @return the first matching syllabus, or <code>null</code> if a matching syllabus could not be found
	*/
	public static Syllabus fetchBySemesterId_First(long semesterId,
		OrderByComparator<Syllabus> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchSyllabusException if a matching syllabus could not be found
	*/
	public static Syllabus findBySemesterId_Last(long semesterId,
		OrderByComparator<Syllabus> orderByComparator)
		throws hu.unideb.inf.exception.NoSuchSyllabusException {
		return getPersistence()
	...
	* @return the last matching syllabus, or <code>null</code> if a matching syllabus could not be found
	*/
	public static Syllabus fetchBySemesterId_Last(long semesterId,
		OrderByComparator<Syllabus> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchSyllabusException if a syllabus with the primary key could not be found
	*/
	public static Syllabus[] findBySemesterId_PrevAndNext(long syllabusId,
		long semesterId, OrderByComparator<Syllabus> orderByComparator)
		throws hu.unideb.inf.exception.NoSuchSyllabusException {
		return getPersistence()
				   .findBySemesterId_PrevAndNext(syllabusId, semesterId,
			orderByComparator);
	}
