...
/**
 * The base model implementation for the Course service. Represents a row in the &quot;syllabus_manager_Course&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CourseModelImpl extends BaseModelImpl<Course>
	 ...
	 */
	public static final String TABLE_NAME = "syllabus_manager_Course";
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("hoursPerSemester", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("hoursPerWeek", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("courseTypeId", Types.BIGINT);
	}

	public static final String TABLE_SQL_CREATE = "create table syllabus_manager_Course (courseId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,subjectId LONG,hoursPerSemester INTEGER,hoursPerWeek INTEGER,courseTypeId LONG)";
	public static final String TABLE_SQL_DROP = "drop table syllabus_manager_Course";
	public static final String ORDER_BY_JPQL = " ORDER BY course.courseId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY syllabus_manager_Course.courseId ASC";
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(hu.unideb.inf.service.util.PropsUtil.get(
			...
			true);
	public static final long COURSETYPEID_COLUMN_BITMASK = 1L;
