...
/**
 * The base model implementation for the TimetableCourse service. Represents a row in the &quot;syllabus_manager_TimetableCourse&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link TimetableCourseModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TimetableCourseImpl}.
 * </p>
 *
 * @author Adam Kiss
...
public class TimetableCourseModelImpl extends BaseModelImpl<TimetableCourse>
	 ...
	 */
	public static final String TABLE_NAME = "syllabus_manager_TimetableCourse";
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("timetableCourseCode", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("subjectType", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("recommendedTerm", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("limit_", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("classScheduleInfo", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("description", Types.VARCHAR);
	}

	public static final String TABLE_SQL_CREATE = "create table syllabus_manager_TimetableCourse (timetableCourseId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,courseId LONG,semesterId LONG,timetableCourseCode TEXT null,subjectType TEXT null,recommendedTerm INTEGER,limit_ INTEGER,classScheduleInfo TEXT null,description TEXT null)";
	public static final String TABLE_SQL_DROP = "drop table syllabus_manager_TimetableCourse";
	public static final String ORDER_BY_JPQL = " ORDER BY timetableCourse.timetableCourseId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY syllabus_manager_TimetableCourse.timetableCourseId ASC";
	...
	public static final long SEMESTERID_COLUMN_BITMASK = 2L;
	public static final long SUBJECTTYPE_COLUMN_BITMASK = 4L;
	public static final long TIMETABLECOURSECODE_COLUMN_BITMASK = 8L;
	public static final long TIMETABLECOURSEID_COLUMN_BITMASK = 16L;
	...
	public static final String MAPPING_TABLE_SYLLABUS_MANAGER_LECTURERS_TIMETABLECOURSES_NAME =
		"syllabus_manager_Lecturers_TimetableCourses";
	public static final Object[][] MAPPING_TABLE_SYLLABUS_MANAGER_LECTURERS_TIMETABLECOURSES_COLUMNS =
		{
			{ "companyId", Types.BIGINT },
			{ "lecturerId", Types.BIGINT },
			{ "timetableCourseId", Types.BIGINT }
		};
	public static final String MAPPING_TABLE_SYLLABUS_MANAGER_LECTURERS_TIMETABLECOURSES_SQL_CREATE =
		"create table syllabus_manager_Lecturers_TimetableCourses (companyId LONG not null,lecturerId LONG not null,timetableCourseId LONG not null,primary key (lecturerId, timetableCourseId))";
	public static final boolean FINDER_CACHE_ENABLED_SYLLABUS_MANAGER_LECTURERS_TIMETABLECOURSES =
		GetterUtil.getBoolean(hu.unideb.inf.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.syllabus_manager_Lecturers_TimetableCourses"),
			true);
	...
	public void resetOriginalValues() {
		...
		timetableCourseModelImpl._setModifiedDate = false;
	...
	private static final ClassLoader _classLoader = TimetableCourse.class.getClassLoader();
