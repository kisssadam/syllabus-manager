...
/**
 * The base model implementation for the CourseType service. Represents a row in the &quot;syllabus_manager_CourseType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link CourseTypeModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CourseTypeImpl}.
 * </p>
 *
 * @author Adam Kiss
 * @see CourseTypeImpl
...
public class CourseTypeModelImpl extends BaseModelImpl<CourseType>
	 ...
	 */
	public static final String TABLE_NAME = "syllabus_manager_CourseType";
	...
	public static final String TABLE_SQL_CREATE = "create table syllabus_manager_CourseType (courseTypeId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,typeName TEXT null)";
	public static final String TABLE_SQL_DROP = "drop table syllabus_manager_CourseType";
	public static final String ORDER_BY_JPQL = " ORDER BY courseType.typeName ASC";
	public static final String ORDER_BY_SQL = " ORDER BY syllabus_manager_CourseType.typeName ASC";
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(hu.unideb.inf.service.util.PropsUtil.get(
			...
			true);
	public static final long TYPENAME_COLUMN_BITMASK = 1L;
	...
	private static final ClassLoader _classLoader = CourseType.class.getClassLoader();
