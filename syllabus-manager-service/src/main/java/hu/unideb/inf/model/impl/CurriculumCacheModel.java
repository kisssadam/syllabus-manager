...
public class CurriculumCacheModel implements CacheModel<Curriculum>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CurriculumCacheModel)) {
			return false;
		}

		CurriculumCacheModel curriculumCacheModel = (CurriculumCacheModel)obj;

		if (curriculumId == curriculumCacheModel.curriculumId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, curriculumId);
	}
