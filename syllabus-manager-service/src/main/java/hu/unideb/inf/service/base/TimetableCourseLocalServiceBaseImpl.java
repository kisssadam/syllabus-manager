...
/**
 * Provides the base implementation for the timetable course local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link hu.unideb.inf.service.impl.TimetableCourseLocalServiceImpl}.
 * </p>
 *
 * @author Adam Kiss
 ...
 */
@ProviderType
public abstract class TimetableCourseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TimetableCourseLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link hu.unideb.inf.service.TimetableCourseLocalServiceUtil} to access the timetable course local service.
	 */
	...
	public TimetableCourse addTimetableCourse(TimetableCourse timetableCourse) {
		...
		return timetableCoursePersistence.update(timetableCourse);
	}
	...
	public TimetableCourse createTimetableCourse(long timetableCourseId) {
		return timetableCoursePersistence.create(timetableCourseId);
	}
	...
	public TimetableCourse deleteTimetableCourse(long timetableCourseId)
		...
		return timetableCoursePersistence.remove(timetableCourseId);
	}
	...
	public TimetableCourse deleteTimetableCourse(
		...
		return timetableCoursePersistence.remove(timetableCourse);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TimetableCourse.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return timetableCoursePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return timetableCoursePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public TimetableCourse fetchTimetableCourse(long timetableCourseId) {
		return timetableCoursePersistence.fetchByPrimaryKey(timetableCourseId);
	}
	...
	public TimetableCourse getTimetableCourse(long timetableCourseId)
		throws PortalException {
		return timetableCoursePersistence.findByPrimaryKey(timetableCourseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(timetableCourseLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TimetableCourse.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("timetableCourseId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(timetableCourseLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TimetableCourse.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return timetableCourseLocalService.deleteTimetableCourse((TimetableCourse)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return timetableCoursePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TimetableCourse> getTimetableCourses(int start, int end) {
		return timetableCoursePersistence.findAll(start, end);
	}
	...
	public int getTimetableCoursesCount() {
		return timetableCoursePersistence.countAll();
	}
	...
	public void addLecturerTimetableCourse(long lecturerId,
		...
		lecturerPersistence.addTimetableCourse(lecturerId, timetableCourseId);
	}
	...
	public void addLecturerTimetableCourse(long lecturerId,
		TimetableCourse timetableCourse) {
		lecturerPersistence.addTimetableCourse(lecturerId, timetableCourse);
	}
	...
	public void addLecturerTimetableCourses(long lecturerId,
		...
		lecturerPersistence.addTimetableCourses(lecturerId, timetableCourseIds);
	}
	...
	public void addLecturerTimetableCourses(long lecturerId,
		...
		lecturerPersistence.addTimetableCourses(lecturerId, timetableCourses);
	}
	...
	public void deleteLecturerTimetableCourse(long lecturerId,
		long timetableCourseId) {
		lecturerPersistence.removeTimetableCourse(lecturerId, timetableCourseId);
	}
	...
	public void deleteLecturerTimetableCourse(long lecturerId,
		TimetableCourse timetableCourse) {
		lecturerPersistence.removeTimetableCourse(lecturerId, timetableCourse);
	}
	...
	public void deleteLecturerTimetableCourses(long lecturerId,
		long[] timetableCourseIds) {
		lecturerPersistence.removeTimetableCourses(lecturerId,
			timetableCourseIds);
	}
	...
	public void deleteLecturerTimetableCourses(long lecturerId,
		List<TimetableCourse> timetableCourses) {
		lecturerPersistence.removeTimetableCourses(lecturerId, timetableCourses);
	}
	...
	public long[] getLecturerPrimaryKeys(long timetableCourseId) {
		return timetableCoursePersistence.getLecturerPrimaryKeys(timetableCourseId);
	}
	...
	public List<TimetableCourse> getLecturerTimetableCourses(long lecturerId) {
		return lecturerPersistence.getTimetableCourses(lecturerId);
	}
	...
	public List<TimetableCourse> getLecturerTimetableCourses(long lecturerId,
		int start, int end) {
		return lecturerPersistence.getTimetableCourses(lecturerId, start, end);
	}
	...
	public int getLecturerTimetableCoursesCount(long lecturerId) {
		return lecturerPersistence.getTimetableCoursesSize(lecturerId);
	}
	...
	public boolean hasLecturerTimetableCourse(long lecturerId,
		long timetableCourseId) {
		return lecturerPersistence.containsTimetableCourse(lecturerId,
			timetableCourseId);
	}
	...
	public boolean hasLecturerTimetableCourses(long lecturerId) {
		return lecturerPersistence.containsTimetableCourses(lecturerId);
	}
	...
	public void setLecturerTimetableCourses(long lecturerId,
		long[] timetableCourseIds) {
		lecturerPersistence.setTimetableCourses(lecturerId, timetableCourseIds);
	}
	 ...
	 */
	public TimetableCourseLocalService getTimetableCourseLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("hu.unideb.inf.model.TimetableCourse",
			timetableCourseLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TimetableCourseLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = timetableCoursePersistence.getDataSource();
