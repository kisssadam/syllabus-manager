...
/**
 * Provides the base implementation for the lecturer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link hu.unideb.inf.service.impl.LecturerLocalServiceImpl}.
 * </p>
 *
 * @author Adam Kiss
 ...
 */
@ProviderType
public abstract class LecturerLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LecturerLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link hu.unideb.inf.service.LecturerLocalServiceUtil} to access the lecturer local service.
	 */
	...
	public Lecturer addLecturer(Lecturer lecturer) {
		...
		return lecturerPersistence.update(lecturer);
	}
	...
	public Lecturer createLecturer(long lecturerId) {
		return lecturerPersistence.create(lecturerId);
	}
	...
	public Lecturer deleteLecturer(long lecturerId) throws PortalException {
		return lecturerPersistence.remove(lecturerId);
	}
	...
	public Lecturer deleteLecturer(Lecturer lecturer) {
		return lecturerPersistence.remove(lecturer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Lecturer.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lecturerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return lecturerPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return lecturerPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lecturerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Lecturer fetchLecturer(long lecturerId) {
		return lecturerPersistence.fetchByPrimaryKey(lecturerId);
	}
	...
	public Lecturer getLecturer(long lecturerId) throws PortalException {
		return lecturerPersistence.findByPrimaryKey(lecturerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(lecturerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Lecturer.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("lecturerId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(lecturerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Lecturer.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("lecturerId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return lecturerLocalService.deleteLecturer((Lecturer)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return lecturerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Lecturer> getLecturers(int start, int end) {
		return lecturerPersistence.findAll(start, end);
	}
	...
	public int getLecturersCount() {
		return lecturerPersistence.countAll();
	}
	...
	public void addTimetableCourseLecturer(long timetableCourseId,
		long lecturerId) {
		timetableCoursePersistence.addLecturer(timetableCourseId, lecturerId);
	}
	...
	public void addTimetableCourseLecturer(long timetableCourseId,
		Lecturer lecturer) {
		timetableCoursePersistence.addLecturer(timetableCourseId, lecturer);
	}
	...
	public void addTimetableCourseLecturers(long timetableCourseId,
		long[] lecturerIds) {
		timetableCoursePersistence.addLecturers(timetableCourseId, lecturerIds);
	}
	...
	public void addTimetableCourseLecturers(long timetableCourseId,
		...
		timetableCoursePersistence.addLecturers(timetableCourseId, lecturers);
	}
	...
	public void deleteTimetableCourseLecturer(long timetableCourseId,
		long lecturerId) {
		timetableCoursePersistence.removeLecturer(timetableCourseId, lecturerId);
	}
	...
	public void deleteTimetableCourseLecturer(long timetableCourseId,
		Lecturer lecturer) {
		timetableCoursePersistence.removeLecturer(timetableCourseId, lecturer);
	}
	...
	public void deleteTimetableCourseLecturers(long timetableCourseId,
		long[] lecturerIds) {
		timetableCoursePersistence.removeLecturers(timetableCourseId,
			lecturerIds);
	}
	...
	public void deleteTimetableCourseLecturers(long timetableCourseId,
		List<Lecturer> lecturers) {
		timetableCoursePersistence.removeLecturers(timetableCourseId, lecturers);
	}
	...
	public long[] getTimetableCoursePrimaryKeys(long lecturerId) {
		return lecturerPersistence.getTimetableCoursePrimaryKeys(lecturerId);
	}
	...
	public int getTimetableCourseLecturersCount(long timetableCourseId) {
		return timetableCoursePersistence.getLecturersSize(timetableCourseId);
	}
	...
	public boolean hasTimetableCourseLecturer(long timetableCourseId,
		long lecturerId) {
		return timetableCoursePersistence.containsLecturer(timetableCourseId,
			lecturerId);
	}
	...
	public boolean hasTimetableCourseLecturers(long timetableCourseId) {
		return timetableCoursePersistence.containsLecturers(timetableCourseId);
	}
	...
	public void setTimetableCourseLecturers(long timetableCourseId,
		long[] lecturerIds) {
		timetableCoursePersistence.setLecturers(timetableCourseId, lecturerIds);
	}
	 ...
	 */
	public LecturerLocalService getLecturerLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("hu.unideb.inf.model.Lecturer",
			lecturerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"hu.unideb.inf.model.Lecturer");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LecturerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = lecturerPersistence.getDataSource();
	...
	@BeanReference(type = LecturerLocalService.class)
	protected LecturerLocalService lecturerLocalService;
